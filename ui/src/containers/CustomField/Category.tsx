            ...
            {!error ? (
              <>
                ...
                <div className="product-body">
                  <span className="product-name">Category: {categories?.name}</span>
                  {categories?.id && (
                    <span className="product-name sub-name">
                      {`${localeTexts.customField.idLbl}: ${categories?.id.length > truncateLength ? categories?.id.substring(0, truncateLength) + '...' : categories?.id}`}
                    </span>
                  )}
                </div>
              </>
